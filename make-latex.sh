...
pandoc -N --quiet --variable "geometry=margin=1.2in" --variable mainfont="carlito" --variable sansfont="carlito" --variable monofont="carlito" --variable fontsize=12pt --variable version=2.0 book.tex  --pdf-engine=xelatex --toc -o book/book.pdf
echo 
